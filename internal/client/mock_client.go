...
// Source: sigs.k8s.io/controller-runtime/pkg/client (interfaces: Client,SubResourceClient)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -package=client -destination mock_client.go sigs.k8s.io/controller-runtime/pkg/client Client,SubResourceClient
//
